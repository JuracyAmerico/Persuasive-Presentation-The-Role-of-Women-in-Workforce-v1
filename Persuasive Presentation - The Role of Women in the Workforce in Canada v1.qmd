...
## Agenda/Overview {.theme-section1 .center}
...
::: notes
-   In this presentation, we will first examine the **reality of the gender pay gap in Canada**, where women earn significantly less than men for similar work.
-   We will then look at the **stark underrepresentation of women in leadership roles**, despite their qualifications and the benefits of diverse leadership.
-   Next, we will discuss the **unequal burdens of unpaid labor** shouldered by women, highlighting how it impacts their career progression.
-   We will then **address and debunk common counter-arguments and harmful stereotypes** that perpetuate these inequalities.
-   Next, we will explore **actionable solutions, including policy changes and cultural shifts**, that can pave the way for a future of true gender equality in Canada.
-   Finally I have my **references** and **Q&A**
:::
...
:::: {#fig-woman fig-cap="<br> _Gap in average_" style="font-size: 16px !important; text-align: left !important;"}
![](images/pay_gap%20v2.png)

::: fig-note
*Note.* Gap in Average hourly wage relative to Canadian-born men, by group of women, 2007 to 2008 and 20221 to 2022. From [@intersec2023] © 2024.
:::
::::
:::::
::::::
...
:::::::: columns
::: {.column width="40%"}
-   **Women earn less than men** (Canadian Women’s Foundation. 2024)
...
::: {.column width="40%"}
-   **Few women lead major companies.** (Canadian Women’s Foundation. 2024)
-   **Diverse leadership boosts profits.**
-   **Support women: mentor, sponsor, promote.** (Canadian Women’s Foundation. 2024)
:::
::::::::
...
::: {.column width="40%"}
-   **Unpaid labor burdens women.** (Heintz et al., 2021)
-   **"Second shift" hurts careers.**
-   **Shared responsibility is key.** (Heintz et al., 2021)
:::
::::::::
...
Now, some might argue against these points. They might say addressing these issues is costly or that women simply aren’t as ambitious. Let’s examine these arguments.
:::
...
::: notes
A common argument is that policies like equitable parental leave or affordable childcare are too expensive. This short-sighted view ignores the economic benefits of women’s full participation in the workforce. Studies show investing in affordable childcare **boosts the economy** by **increasing productivity** and allowing more women to work.

Another argument relies on harmful stereotypes, suggesting women are less ambitious or lack leadership qualities. This simply isn't true. Research consistently debunks this myth, showing women are just as **interested in leadership roles** but face greater obstacles throughout their careers.
:::

## Rebuttals: Economic Benefits & Debunking Stereotypes {.theme-slide6 visibility="hidden"}
...
[@canadianwomensfoundation2024]

[@charters2006]

[@governmentofcanada2023]
